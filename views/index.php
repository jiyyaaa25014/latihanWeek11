...
<head>
    ...
    <link rel="stylesheet"
        href="/latihanWeek9-tekweb/assets/css/bootstrap.css" />
    <script type="text/javascript"
        src="/latihanWeek9-tekweb/assets/js/bootstrap.js"></script>
</head>
            ...
            <div class="col-md-4">
                ...
                <form method="post" action="/mvc-example/?act=simpan">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputNim"
